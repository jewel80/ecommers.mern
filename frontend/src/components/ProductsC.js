        ...
        <>
            <div className='Cgfilter'>
                ...
                <div className='filters'>
                    <ul>
                        <Link className='lined' >All</Link>
                        <Link className='lined' >Men</Link>
                        <Link className='lined' >Women</Link>
                        <Link className='lined' >Watches</Link>
                        <Link className='lined' >Shoes</Link>
                    </ul>
                </div>
            </div>
